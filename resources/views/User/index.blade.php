    ...
    <div class="card" style="min-height: 90%;">
        <div class="card-header" style="display: flex;flex-direction: row;justify-content: space-between">
            ...
            <div class="align-items-center">
                <form action="{{route("users.index")}}" method="get" id="searchFormSec">
                    @csrf
            ...
            @can("ثبت-کاربران")
                <h6 class="btn btn-primary "><a class="text-white" href="{{route("users.create")}}">ثبت آیتم جدید</a></h6>
            @endcan
        </div>
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" style="text-align: right;">
                                        ...
                                        @endcan
                                        @can("حذف-کاربران")
                                            <a class="dropdown-item" href="{{route('users.destroy',['id'=>$user->id])}}"><i
                ...
                @else
                    ...
                    @else
                        @php
                            $message="تاکنون کاربر جدیدی ثبت نشده است";
                        @endphp
                    @endif
                    <tr>
                        <th scope="row">{{$counter++}}</th>
