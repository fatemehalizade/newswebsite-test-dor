...
@endsection
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('admins.index')}}">ادمین ها</a> /</span> ویرایش </h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">ویرایش</h5> <small class="text-muted float-end"><a href="{{route('admins.index')}}">بازگشت</a></small>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{route('admins.update',['id'=>$user->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
