...
@endsection
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('news.index')}}">اخبار</a> /</span> ویرایش </h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">ویرایش</h5> <small class="text-muted float-end"><a href="{{route('news.index')}}">بازگشت</a></small>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{route('news.update',['id'=>$news->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10 col-md-3">
                                @if($news->image)
                                    <img src="{{asset("storage/".$news->image)}}" width="150px" height="150px" />
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" id="title" placeholder="عنوان" value="{{$news->title}}"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="categoryId" class="form-control">
                                    <x-categories-s-o :categories="$categories" :parentId="$news->category_id" />
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10 col-md-8">
                                ...
                                <input type="hidden" name="publishedAtH" id="publishedAtH" value="{{$news->published_at}}">
                            </div>
                            <label class="col-sm-2 col-form-label text-danger" for="basic-default-name">انتخاب شده :  {{$news->published_at}}</label>
                        </div>
