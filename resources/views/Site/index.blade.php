...
<head>
    <meta charset="utf-8">
    <title>وبسایت خبری | صفحه اصلی</title>
...
{{--                    <div class="overlay">--}}
{{--                        <div class="mb-2">--}}
{{--                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                               href="">کار</a>--}}
{{--                            <a class="text-white" href="">1402-09-25</a>--}}
{{--                        </div>--}}
{{--                        <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="">این یک متن تکراری است ...</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="position-relative overflow-hidden" style="height: 500px;">--}}
...
{{--                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                               href="">کار</a>--}}
{{--                            <a class="text-white" href="">1402-08-29</a>--}}
{{--                        </div>--}}
{{--                        <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="">این یک متن تکراری است ...</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                               href="">کار</a>--}}
{{--                            <a class="text-white" href="">1402-10-04</a>--}}
{{--                        </div>--}}
{{--                        <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="">این یک متن تکراری است ...</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                                   href="">کار</a>--}}
{{--                                <a class="text-white" href=""><small>1402-07-15</small></a>--}}
{{--                            </div>--}}
{{--                            <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک متن تکراری است</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="col-md-6 px-0">--}}
...
{{--                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                                   href="">کار</a>--}}
{{--                                <a class="text-white" href=""><small>1402-08-20</small></a>--}}
{{--                            </div>--}}
{{--                            <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک متن تکراری است ...</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                                   href="">کار</a>--}}
{{--                                <a class="text-white" href=""><small>1402-09-09</small></a>--}}
{{--                            </div>--}}
{{--                            <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک متن تکراری است ...</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                                   href="">کار</a>--}}
{{--                                <a class="text-white" href=""><small>1402-07-12</small></a>--}}
{{--                            </div>--}}
{{--                            <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک متن تکراری است ...</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                    <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center mr-3"--}}
...
{{--                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                           href="">سیاسی</a>--}}
{{--                        <a class="text-white" href=""><small>1402-06-06</small></a>--}}
{{--                    </div>--}}
{{--                    <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک خبر تستی است ...</a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="position-relative overflow-hidden" style="height: 300px;">--}}
...
{{--                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                           href="">فرهنگی</a>--}}
{{--                        <a class="text-white" href=""><small>1402-03-20</small></a>--}}
{{--                    </div>--}}
{{--                    <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک خبر تستی است ...</a>--}}
{{--                </div>--}}
{{--            </div>--}}
...
{{--                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                           href="">فرهنگی</a>--}}
{{--                        <a class="text-white" href=""><small>1402-05-14</small></a>--}}
{{--                    </div>--}}
{{--                    <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک خبر تستی است ...</a>--}}
{{--                </div>--}}
{{--            </div>--}}
...
{{--                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                           href="">سیاسی</a>--}}
{{--                        <a class="text-white" href=""><small>1402-04-28</small></a>--}}
{{--                    </div>--}}
{{--                    <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک خبر تستی است ...</a>--}}
{{--                </div>--}}
{{--            </div>--}}
...
{{--                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"--}}
{{--                           href="">کار</a>--}}
{{--                        <a class="text-white" href=""><small>1402-09-13</small></a>--}}
{{--                    </div>--}}
{{--                    <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">این یک خبر تستی است ...</a>--}}
{{--                </div>--}}
{{--            </div>--}}
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">آخرین اخبار</h4>
{{--                            <a class="text-secondary font-weight-medium text-decoration-none" href="">مشاهده همه</a>--}}
                        </div>
                    </div>
                        ...
                        @foreach($latestNews as $news)
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    <img class="img-fluid w-100" src="{{$news->image ? asset("storage/".$news->image) : asset("assets/img/news-110x110-5.jpg")}}" style="object-fit: cover;height: 230px;">
                                    <div class="bg-white border border-top-0 p-4">
                                        <div class="mb-2">
                                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 ml-2"
                                               href="">{{$news->Category->name}}</a>
                                            <a class="text-body" href=""><small>{{\Morilog\Jalali\Jalalian::forge(convertShamsiToMiladi($news->published_at))->format('%B %d، %Y')}}</small></a>
                                        </div>
                                        <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="{{route("site.detail",["id" => $news->id,"slug" => $news->slug])}}">{!! $news->title !!}</a>
                                        <p class="m-0">{!! $news->summary !!}</p>
                                    </div>
                                    <div class="d-flex justify-content-between bg-white border border-top-0 p-4">

                                        <div class="d-flex align-items-center">
                                            <small class="ml-3"><i class="far fa-eye ml-2"></i>{{$news->views}}</small>
                                            <small class="ml-3"><i class="far fa-comment ml-2"></i>123</small>
