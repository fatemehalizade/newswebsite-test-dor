...
@endsection
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('profile.index')}}">پروفایل</a> /</span> ویرایش </h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">ویرایش</h5> <small class="text-muted float-end"><a href="{{route('profile.index')}}">بازگشت</a></small>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{route('profile.update',["id" => $user->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="radio"  name="gender" id="showInSlider" value="0" @checked($user->gender == \App\Enums\GenderTypes::male)/>
                                ...
                                <select name="provinceId" id="provinceSec" class="form-control">
                                    ...
                                    @foreach($provinces as $province)
                                        <option value="{{$province->id}}" onclick="citiesFunc({{$province->id}})"
                                                id="{{$province->id}}" @selected($user->province_id == $province->id)>{{$province->name}}</option>
                                    @endforeach
                                </select>
                            </div>
